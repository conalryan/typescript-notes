...
export class BlogCardElement extends HTMLElement {
...
render() {
    ...
    const templateNode = document.getElementById('card-template') as HTMLTemplateElement;
...
customElements.define('blog-card', BlogCardElement);
